...
const SERIES = [
  550101, 550102, 550103, 550104, 550105, 550106, 550107, 550108, 550109, 550110, 550111, 550112, 550113, 550114, 550115, 550116, 550117,
...
for (let i = 1; i <= 17; i++) SETCODE[550100 + i] = 'OP' + String(i).padStart(2, '0');
