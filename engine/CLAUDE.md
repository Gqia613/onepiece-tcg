...
- **カード: 全3065枚が公式と完全一致**（トリガー580枚含む・audit 差分ゼロ）。OP-01〜16 全弾＋EB/ST/P/PRB 625枚の意味照合済み・既知近似5種（scry 完全実装/残り配置選択/コスト原子性/同一対象除外/バトル終了時フック）も解消済み。残: CPU のトリガー判断品質・実機 E2E は目視のみ。
