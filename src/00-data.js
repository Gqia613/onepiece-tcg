    ...
    /* ============================ 青黄ナミ (Tier2) ============================ */
    def({
      no: 'OP11-041', name: 'ナミ', color: ['青', '黄'], type: 'LEADER', life: 5, power: 5000, traits: ['麦わらの一味'], leader: 'nami',
    ...
    /* ============================ 青黄ハンコック (Tier3) ============================ */
    def({
      no: 'OP14-041', name: 'ボア・ハンコック', color: ['青', '黄'], type: 'LEADER', life: 5, power: 5000, traits: ['王下七武海', '九蛇海賊団'], leader: 'hancock',
    ...
    /* =========================================================================
       ...
       ========================================================================= */
    def({
      no: 'OP16-080', name: 'マーシャル・Ｄ・ティーチ', color: ['黒', '黄'], type: 'LEADER', life: 5, power: 5000, traits: ['王下七武海', '黒ひげ海賊団'], leader: 'teach',
