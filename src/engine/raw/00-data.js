    ...
    const DECKS = [
      ...
      {
        // 黒ヤマト（OP16新リーダー）。CLAUDE.md準拠で記事を丸写しせず、CARD_DBの黒/ワノ国カードから蘇生速攻エンジン中心に論理構築。
        ...
        desc: 'OP16新リーダー。ドロー/捨てや「その“縁”」でトラッシュを肥やし、リーダー効果で《ワノ国》を【速攻】蘇生。6ヤマト→8ヤマト蘇生やモモの助でアタック回数を稼ぎ、高パワーで押し切る蘇生アグロ。',
        list: {
          'OP16-098': 4, 'OP16-096': 4, 'OP16-097': 2, 'OP16-099': 4, 'OP16-085': 2,
          'OP16-082': 4, 'OP16-083': 4, 'OP16-090': 3, 'OP16-087': 2,
